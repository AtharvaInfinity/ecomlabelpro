...
await uploadRoutes(app);await processRoutes(app);await flipkartProcessRoutes(app);await meeshoProcessRoutes(app);await mergePdfRoutes(app);await downloadRoutes(app)
